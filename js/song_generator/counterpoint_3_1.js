...
function acceptNoteInCounterpoint31(note3Value, tonicValue, barIndex, nbBars, track31, track11, trackCF = null) {
    const track11NbNotes = track11.GetNbNotes();
    const track31NbNotes = track31.GetNbNotes();
    const hasTrackCF = (trackCF != null && trackCF.Events != null && trackCF.Events.length > 1);
    ...
    // prevent 3 consecutive same notes
        ...
        let has3ConsecutiveSameNotes = (note1Value == note1ValueNext && note3Value == note1ValueNext);
...
function checkCounterpoint31(track1, track2) {
...
function ReduceTrack31(track31, channelId) {
