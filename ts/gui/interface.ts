...
const languages: Array<string> = ["en", "es", "fr", "it", "pt"];
...
window.onload = function () {
    ...
    const languageFlag = <HTMLImageElement>document.getElementById("languageFlag");
    ...
    if (customDropdown) {
        ...
        (window as any).selectedLanguage = urlLang;
