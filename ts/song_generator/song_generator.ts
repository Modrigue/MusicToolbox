...
function updateSongGeneratorPage(): void
{
    ...
    if (selectedTypeId != null)
    {
        ...
        // update track texts
        const track1Text = (<HTMLButtonElement>document.getElementById(`song_generator_checkbox_track1_text`));
        const track2Text = (<HTMLButtonElement>document.getElementById(`song_generator_checkbox_track2_text`));
