...
function acceptNoteInCounterpoint11(noteValue: number, tonicValue: number, barIndex: number, nbBars: number,
...
function checkCounterpoint11(track1: MidiTrack, track2: MidiTrack): boolean
{
